    ...
    <section class="section-margin">
        ...
        <div class="container">
            <div class="brand-slider sb-slick-slider border-top border-bottom"
                ...
                <div class="single-slide">
                    <img src="template/image/others/brand-2.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="template/image/others/brand-3.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="template/image/others/brand-4.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="template/image/others/brand-5.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="template/image/others/brand-6.jpg" alt="">
                </div>
                <div class="single-slide">
                    <img src="template/image/others/brand-1.jpg" alt="">
                </div>
