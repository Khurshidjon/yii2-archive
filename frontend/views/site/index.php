                ...
                <div class="product-card">
                    <div class="product-grid-content">
                        <div class="product-header">
                            ...
                            <h3><a href="product-details.html"><?= $file->title?></a></h3>
                        </div>
                        <div class="product-card--body">
                            <div class="card-image">
                                ...
                                <div class="hover-contents">
                                    ...
                                    <div class="hover-btns">
                                        <a href="https://telegram.me/share/url?url=<?=\yii\helpers\Url::to(["site/index"], 'http')?>" class="single-btn">
                                            <i class="fab fa-telegram-plane"></i>
                                        </a>
                                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?=\yii\helpers\Url::to(["site/index"], 'http')?>" class="single-btn">
                            ...
                            <div class="price-block">
                                <span class="price"><?= Yii::$app->homeUrl; ?></span>
