...
?>
    ...
    <div id="panel-option-values" class="panel panel-default">
        ...
        <?php DynamicFormWidget::begin([
            ...
            'widgetItem' => '.form-options-item1111',
            'min' => 1,
        ...
        <table class="table table-bordered table-striped margin-b-none">
            ...
            <?php foreach ($modelsOptionValue as $index => $modelOptionValue): ?>
                <tr class="form-options-item1111">
                    ...
                    <td>
                        ...
                        <?php endif; ?>
                        <?php
                        $modelImage = \common\models\Files::findOne(['id' => $modelOptionValue->id]);
                        $initialPreview = [];
                        if ($modelImage) {
                        ...
                        ?>
                        <?= $form->field($modelOptionValue, "[{$index}]id")->label(false)->widget(FileInput::classname(), [
                            'options' => [
                                'multiple' => false,
//                                'accept' => 'image/*',
